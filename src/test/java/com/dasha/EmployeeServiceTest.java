...
public class EmployeeServiceTest {
    ...
    private final Employee Gennadiy = Employee.builder()
                ...
                .post(map.getById(UUID.fromString("854ef89d-6c27-4635-926d-894d76a81707")))
                .build();
    ...
    private final Employee Daria = Employee.builder()
                ...
                .post(map.getById(UUID.fromString("a3dec21f-1187-4b05-896b-96b580b453a5")))
                .build();
    ...
    private final Employee Petr = Employee.builder()
                ...
                .post(map.getById(UUID.fromString("854ef89d-6c07-4665-936d-894d76a81707")))
                .build();
